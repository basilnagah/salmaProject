...
<nav class="navbar bg-dark bg-body-tertiary fixed-top">
    <div class="container-fluid">
        ...
        <a class="navbar-brand text-center text-light" href="{{url('/')}}">Salma <span>store</span></a>
        
        <a class="text-light" href="{{route('cartList')}}" style="width:50px"><i class="fa-solid fa-cart-shopping"></i></a>
