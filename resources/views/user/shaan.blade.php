...
<body>
    ...
    <div class="shaan w-25">
        <h2 style="text-align: right">{{$shippingPolicy->title}}</h2>
...
{{-- 
    <div class="shaan w-25">
        <h2 style="text-align: right">:سياسة الشحن</h2>
        <p style="text-align: right">
            سياسة الشحن:

            يتم شحن جميع الطلبات من مقرنا الرئيسية <br> في القاهرة عبر إحدى شركات خدمات البريد السريع لدينا<br> إلى أي مكان داخل
            وخارج مصر .

            بعد تقديم طلب ، ستتلقى<br> بريدًا إلكترونيًا أو رسالة نصية قصيرة تؤكد استلامنا لطلبك <br>ونقوم بمعالجته.
            لإبقائك على اطلاع بشأن تقدم طلبك<br> ، سنرسل المزيد من إشعارات البريد الإلكتروني أو الرسائل<br> النصية القصيرة أثناء
            إرسال طلبك.

            هدفنا دائمًا هو شحن<br> طلبك في أسرع وقت ممكن ، ولكن اعتمادًا على وقت تقديم <br>طلبك ومدى انشغالنا ، قد يستغرق طلبك
            ما يصل إلى 5 أيام<br> عمل للشحن من وقت تقديمه.

            إذا كانت لديك أي أسئلة حول<br> طلبك ، فيرجى الاتصال بنا.
        </p>
    </div> --}}
